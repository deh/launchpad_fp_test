...
@ options passed:  -fpreprocessed USART1_txint_send.i -mcpu=cortex-m3
@ -mthumb -auxbase-strip USART1_txint_send.o -g -Os -Wall -Wextra
...
@ Compiler executable checksum: f905e5265c5e2bdb166d278b4b873d0b
	...
	.align	1
	.global	USART1_txint_send
	.thumb
	.thumb_func
	.type	USART1_txint_send, %function
USART1_txint_send:
.LFB0:
	.file 1 "USART1_txint_send.c"
	.loc 1 15 0
	.cfi_startproc
...
.LCFI0:
	...
	.cfi_offset 14, -4
	.cfi_offset 3, -8
	ldr	r0, [r3, #0]	@, pUSARTcbt1
	bl	usartx_txint_send	@
	cbnz	r0, .L1	@,
	.loc 1 19 0
	ldr	r3, .L3+4	@ tmp137,
	movs	r2, #1	@ tmp138,
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	USART1_txint_send, .-USART1_txint_send
.Letext0:
