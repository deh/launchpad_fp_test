...
# 11 "usartx_setbaud.c" 2
# 1 "usartprotoprivate.h" 1
# 14 "usartprotoprivate.h"
# 1 "../libusartstm32/usartall.h" 1
# 25 "../libusartstm32/usartall.h"
# 1 "../libusartstm32/../libopenstm32/common.h" 1
# 26 "../libusartstm32/usartall.h" 2
...
# 15 "usartprotoprivate.h" 2
# 1 "../libusartstm32/usartallproto.h" 1
# 16 "usartprotoprivate.h" 2
...
void usartx_setbaud (u32 usartx, u32 u32BaudRate)
{
 ...
 if ( usartx == ((0x40000000 + 0x10000) + 0x3800))
 {
  apbclock = pclk2_freq;
 }
 else
 ...
 tmpreg |= ((((fractionaldivider * 0x10) + 0x32) / 0x64)) & ((u8)0x0F);
   ...
   (*(volatile u32 *)(usartx + 0x08)) = (u16)tmpreg;
 return;
}
