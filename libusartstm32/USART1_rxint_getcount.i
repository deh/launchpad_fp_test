...
# 10 "USART1_rxint_getcount.c" 2
# 1 "../libusartstm32/usartall.h" 1
# 11 "USART1_rxint_getcount.c" 2
# 37 "USART1_rxint_getcount.c"
u16 USART1_rxint_getcount(void)
{
 return (*pUSARTcbr1->prx_ctary_now_m);
}
