# 1 "USART1_rxinttxint.c"
# 1 "/home/deh/launchpad_fp_test/libusartstm32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "USART1_rxinttxint.c"
# 28 "USART1_rxinttxint.c"
...
# 29 "USART1_rxinttxint.c" 2
# 1 "../libopenstm32/memorymap.h" 1
# 30 "USART1_rxinttxint.c" 2
...
# 38 "USART1_rxinttxint.c" 2
# 1 "../libusartstm32/usartbitband.h" 1
# 16 "../libusartstm32/usartbitband.h"
# 1 "../libusartstm32/../libopenstm32/usart.h" 1
# 17 "../libusartstm32/usartbitband.h" 2
# 1 "../libusartstm32/../libusartstm32/commonbitband.h" 1
# 18 "../libusartstm32/usartbitband.h" 2
# 39 "USART1_rxinttxint.c" 2
# 1 "../libusartstm32/nvicdirect.h" 1
# 15 "../libusartstm32/nvicdirect.h"
# 1 "../libusartstm32/../libopenstm32/memorymap.h" 1
# 16 "../libusartstm32/nvicdirect.h" 2
# 40 "USART1_rxinttxint.c" 2
...
u16 USART1_rxinttxint_init (u32 BaudRate,u16 RcvLineSize, u16 NumberRcvLines, u16 XmtLineSize, u16 NumberXmtLines)
{
 ...
 (*(volatile u32 *)(((0x40000000 + 0x10000) + 0x0800) + 0x04)) |= (( (0x02<<2) | (0x03) ) << (4*1));


 (*(volatile u32 *)(((0x40000000 + 0x18000) + 0x09000) + 0x18)) |= (1 << 14);
 ...
 usartx_txint_usart_init (((0x40000000 + 0x10000) + 0x3800),BaudRate);

 usartx_rxint_usart_init (((0x40000000 + 0x10000) + 0x3800),BaudRate);


 ( *(u32*)(((0xE0000000 + 0xE000) + 0x0100) + 0x300 + ((37 / 4) * 4)) ) |= (0x40 << ((37 % 4) * 8));
 (*(u32*)(((0xE0000000 + 0xE000) + 0x0100) + 0x000 + (37/32)*4)) |= (1<<(37 % 32));
 return 0 ;
}
...
void USART1_IRQHandler(void)
{
 ...
 if ( *((volatile unsigned long *) ((((((0x40000000 + 0x10000) + 0x3800) + 0x00) & 0xf0000000)+0x02000000+(((((0x40000000 + 0x10000) + 0x3800) + 0x00) & 0xfffff)<<5)+(5<<2)))) != 0)
 {
  *pUSARTcbr1->prx_now_i = (*(volatile u32 *)(((0x40000000 + 0x10000) + 0x3800) + 0x04));


  usartx_rxint_rxisrptradv(pUSARTcbr1);
 }


 if (*((volatile unsigned long *) ((((((0x40000000 + 0x10000) + 0x3800) + 0x0c) & 0xf0000000)+0x02000000+(((((0x40000000 + 0x10000) + 0x3800) + 0x0c) & 0xfffff)<<5)+(7<<2)))) != 0)
 {
  if (*((volatile unsigned long *) ((((((0x40000000 + 0x10000) + 0x3800) + 0x00) & 0xf0000000)+0x02000000+(((((0x40000000 + 0x10000) + 0x3800) + 0x00) & 0xfffff)<<5)+(7<<2)))) != 0)
  {
   (*(volatile u32 *)(((0x40000000 + 0x10000) + 0x3800) + 0x04)) = *pUSARTcbt1->ptx_now_d++;
   *pUSARTcbt1->ptx_ctary_now_d -= 1;
   if (*pUSARTcbt1->ptx_ctary_now_d == 0)
   {
    ...
    if (*pUSARTcbt1->ptx_ctary_now_d == 0)
    {
     *((volatile unsigned long *) ((((((0x40000000 + 0x10000) + 0x3800) + 0x0c) & 0xf0000000)+0x02000000+(((((0x40000000 + 0x10000) + 0x3800) + 0x0c) & 0xfffff)<<5)+(7<<2)))) = 0x00;
    }
