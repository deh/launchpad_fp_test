...
@ options passed:  -fpreprocessed USART1_rxint_getcount.i -mcpu=cortex-m3
@ -mthumb -auxbase-strip USART1_rxint_getcount.o -g -Os -Wall -Wextra
...
.LFB0:
	...
	.loc 1 39 0
	ldr	r3, .L2	@ tmp139,
	ldr	r3, [r3, #0]	@ pUSARTcbr1, pUSARTcbr1
	ldr	r3, [r3, #20]	@ pUSARTcbr1.0_1->prx_ctary_now_m, pUSARTcbr1.0_1->prx_ctary_now_m
	.loc 1 40 0
	ldrh	r0, [r3, #0]	@,* pUSARTcbr1.0_1->prx_ctary_now_m
	bx	lr	@
.L3:
	.align	2
.L2:
