...
# 8 "usartx_tx_advlnptr.c" 2
# 1 "../libusartstm32/usartall.h" 1
# 9 "usartx_tx_advlnptr.c" 2
...
void usartx_txmain_advlnptr (struct USARTCBT* pUSARTcbtx)
{
 ...
 pUSARTcbtx->ptx_begin_m += pUSARTcbtx->tx_ln_sz;
 pUSARTcbtx->ptx_ctary_now_m += 1;


 if (pUSARTcbtx->ptx_begin_m >= pUSARTcbtx->ptx_end)
 {
  pUSARTcbtx->ptx_begin_m = pUSARTcbtx->ptx_begin;
  pUSARTcbtx->ptx_ctary_now_m = pUSARTcbtx->ptx_ctary_begin;
 }
 pUSARTcbtx->ptx_now_m = pUSARTcbtx->ptx_begin_m;
...
void usartx_txisr_advlnptr (struct USARTCBT* pUSARTcbtx)
{
 ...
 pUSARTcbtx->ptx_begin_d += pUSARTcbtx->tx_ln_sz;
 pUSARTcbtx->ptx_ctary_now_d += 1;


 if (pUSARTcbtx->ptx_begin_d >= pUSARTcbtx->ptx_end)
 {
  pUSARTcbtx->ptx_begin_d = pUSARTcbtx->ptx_begin;
  pUSARTcbtx->ptx_ctary_now_d = pUSARTcbtx->ptx_ctary_begin;
 }
 pUSARTcbtx->ptx_now_d = pUSARTcbtx->ptx_begin_d;
